...
```{r presentation,echo=TRUE,warning=FALSE,message=FALSE,error=FALSE, results='asis'}
...
```{r function,echo=TRUE,warning=FALSE,message=FALSE,error=FALSE, results='asis'}
...
```{r TOS,echo=TRUE,warning=FALSE,message=FALSE,error=FALSE}
```


---
title: "build_leaflet_template.fun.R"
author: "rstudio"
date: "Mon Apr 23 08:05:52 2018"
---
